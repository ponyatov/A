...
% titles
\def \thetitle {Азбука халтурщика-ARMатурщика}
\def \theauthorA
{\href{https://groups.google.com/forum/\#!forum/openwrt2ru}{ruOpenWrt}} 

\def \theauthorB {HackSpace
<<\href{https://github.com/ponyatov/CHBZ/raw/master/presentation.pdf}{Чебураторный завод}>>}

\def \theauthorC {Консорциум хоббитов России} 
\def \theauthorD {Bill Collis} 
\def \githubURL {https://github.com/ponyatov/Azbuka}
