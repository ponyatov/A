...
% 6.19 Microcontroller ports: write a Knightrider program using LED’s  79
...
% 26.3 Stage 1: step down transformer  372
% 26.4 Stage 2: AC to DC Conversion  374
% 26.5 Stage 3: Filtering AC component . 375
% 26.6 Stage 4: Voltage Regulation  375
...
\chapter{30 Дополнительно: подключение клавиатуры 403}
...
\chapter{35 System Design Example – Temperature Controller  475}
\chapter{36 Advanced programming - state machines  478}
...
\chapter{37 Alarm clock project re-developed . 501}
...
\chapter{38 Advanced window controller student project  514}
...
\chapter{39 Alternative state machine coding techniques  524}
\chapter{40 Complex - serial communications . 526}
...
% 40.25 GPS  591
\chapter{41 Radio Data Communication  597}
...
\chapter{42 Introduction to I2C  617}
...
\chapter{49 LED dot matrix scrolling display project – arrays and timers . 698}
% 49.1 Scrolling text code  701
% 49.2 Scrolling text – algorithm design  703
% 49.3 Scrolling test - code  704
\chapter{50 Medical machine project – timer implementation  709}
% 50.1 Block diagram  709
% 50.2 Blower - state machine  710
% 50.3 Blower program code . 711
\chapter{51 Multiple 7-segment clock project – dual timer action  715}
...
\chapter{52 The MAX 7219/7221 display driver IC’s  739}
% 52.1 AVR clock/oscillator  743
\chapter{53 Cellular Connectivity-ADH8066  744}
...
\chapter{54 Data transmission across the internet  778}
% 54.1 IP address  779
...
\chapter{55 Assignment – maths in the real world  816}
...
\chapter{56 SSD1928 based colour graphics LCD . 825}
...
\chapter{57 Traffic Light help and solution  865}
\chapter{58 Computer programming – low level detail  869}
% 58.1 Low level languages: 869
...
\chapter{59 USB programmer - USBASP . 876}
\chapter{60 USBTinyISP programmer  877}
\chapter{61 C-Programming and the AVR  881}
...
% 61.28 CharLCD.h . 919
% 61.29 CharLCD.c . 922
\chapter{62 Object Oriented Programming (OOP) in CPP and the AVR  929}
...
\chapter{63 Current (2014) AVR development PCBS  953}
...
\chapter{64 Eagle - creating your own library  970}
% 64.1 Autorouting PCBS  977
\chapter{65 Practical Techniques . 979}
