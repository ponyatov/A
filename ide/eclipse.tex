...
\begin{enumerate}
  ...
  \menu{\file{Aspell-0-50-3-3-Setup.exe}>Setup GNU Aspell>Next}
  ...
  \menu{\file{Aspell-en-0.50-2-3.exe}>Aspell English Dictionary>Next}
  ...
  \menu{\file{Aspell-ru-0.50-2-3.exe}>Aspell Russian Dictionary>Next}
