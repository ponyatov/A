...
\input{linux/sdl/lf01}
\input{linux/sdl/lf02}
\input{linux/sdl/lf03}
\input{linux/sdl/lf04}
\input{linux/sdl/lf05}
\input{linux/sdl/lf06}
...
\lstx{user/sdl\_hello.c}{}{L/user/sdl_hello.c}{c}

\clearpage\secrel{Вывод случайных прямоугольников}

\lstx{user/sdl\_rect.c}{}{L/user/sdl_rect.c}{c}
